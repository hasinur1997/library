			...
			<div class="panel-body"> 
				...
				<form action="" method="post">
					...
					<div class="form-group<?php echo $errorHandler->first('book_title') != null ? ' has-error' : ''?>"> 
						...
						<input type="text" name="book_title" id="book-title" class="form-control" value="<?php echo $book->book_title;?>">
					...
					<div class="form-group<?php echo $errorHandler->first('author_name') != null ? ' has-error' : ''?>"> 
						...
						<input type="text" name="author_name" id="author-name" class="form-control" value="<?php echo $book->author;?>">
					...
					<div class="form-group<?php echo $errorHandler->first('publish_date') != null ? ' has-error' : ''?>"> 
						...
						<input type="text" name="publish_date" id="publish-date" class="form-control datepicker" value="<?php echo $book->publis_date;?>">
